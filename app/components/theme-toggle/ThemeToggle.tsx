...
export function ThemeToggle() {
  ...
  return (
    <div
      className="flex items-center justify-center text-muted-foreground size-8 rounded-lg md:rounded-full border dark:border-muted-foreground relative cursor-pointer"

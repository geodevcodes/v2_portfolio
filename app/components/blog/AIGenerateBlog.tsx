...
export function AIGenerateBlog({
  ...
  return (
    <div className="p-4 border dark:border-accent rounded-lg">
      ...
      <div className="space-y-4">
        ...
        <button
          ...
          disabled={isLoading}
          className="flex items-center justify-center px-4 py-2 font-light shadow-sm bg-primary text-white rounded"
        >
          {isLoading ? (
            <>
